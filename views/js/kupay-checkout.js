...
(function renderKupayButton() {
    ...
    const elementDiv = document.getElementById("js-checkout-summary");
    if (elementDiv) {
        elementDiv.appendChild(node);
    }
    if (kupay.checkoutStyles) {
        node.setAttribute("style", kupay.checkoutStyles);
    }

    console.log('A', document.getElementsByClassName('kupay-buy'));
})();
